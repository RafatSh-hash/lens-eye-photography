...
const Blog = () => {
  ...
  return (
    <div className="p-5 mt-0">
      {/* <h1>Hello Blog</h1> */}
      <div className="border-4 border-slate-900 border-double bg-gradient-to-bl from-blue-200 via-indigo-300 to-gray-300 shadow-gray-700 shadow-2xl rounded-2xl p-8 text-left w-4/6 mx-auto mt-10">
